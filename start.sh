...
docker exec -e "CORE_PEER_LOCALMSPID=warehouseMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/warehouse.supplychain.com/users/Admin@warehouse.supplychain.com/msp" cli peer chaincode install -o orderer.supplychain.com:7050 -n sc -v 0 -p "github.com/supplychain"
docker exec -e "CORE_PEER_ADDRESS=peer0.collection.supplychain.com:7051" -e "CORE_PEER_LOCALMSPID=collectionMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/collection.supplychain.com/users/Admin@collection.supplychain.com/msp" cli peer chaincode install -n sc -v 0 -p "github.com/supplychain"
docker exec -e "CORE_PEER_ADDRESS=peer0.customer.supplychain.com:7051" -e "CORE_PEER_LOCALMSPID=customerMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/customer.supplychain.com/users/Admin@customer.supplychain.com/msp" cli peer chaincode install -n sc -v 0 -p "github.com/supplychain"

docker exec -e "CORE_PEER_LOCALMSPID=warehouseMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/warehouse.supplychain.com/users/Admin@warehouse.supplychain.com/msp" cli peer chaincode instantiate -o orderer.supplychain.com:7050 -C supplychainchannel -n sc -v 0 -c '{"Args":[""]}' -P "OR ('warehouseMSP.member','collectionMSP.member','customerMSP.member')"
...
#sleep 5
#docker exec -e "CORE_PEER_LOCALMSPID=customerMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/customer.supplychain.com/users/Admin@customer.supplychain.com/msp" cli peer chaincode query -C supplychainchannel -n sc -c '{"function":"queryPackage","Args":["2"]}'
